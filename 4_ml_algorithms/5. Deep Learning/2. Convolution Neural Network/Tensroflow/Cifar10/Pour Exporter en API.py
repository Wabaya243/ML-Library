...
with open("Exportation/new_model.tflite", "wb") as f:  # => dans le dossier Save/
...
# Si ton modèle n'utilise que des ops TFLITE_BUILTINS:
converter.target_spec.supported_ops = [tf.lite.OpsSet.TFLITE_BUILTINS]

# Si ton modèle a besoin d'ops TF non compatibles builtin, tu devras ajouter SELECT_TF_OPS :
...
tflite_model = converter.convert()
open("Exportation/new_model.tflite","wb").write(tflite_model)
