...
from tensorflow.keras.layers import GRU         # Import de la couche LSTM (Long Short-Term Memory), adaptée au traitement de séquences textuelles.
...
model.add(Bidirectional(GRU(256, dropout=0.3, recurrent_dropout=0.3)))  
