...
# -------------------------
# IMDB est un dataset de critiques de films : label=0 négatif, label=1 positif
...
texte_generé = sentiment_guided_generation("I had a really bad day today")
