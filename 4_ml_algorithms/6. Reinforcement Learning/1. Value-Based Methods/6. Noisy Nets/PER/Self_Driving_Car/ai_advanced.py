...
# PER DOUBLE DQN avec Noisy Nets
...
class NoisyNetwork(nn.Module):
    def __init__(self, input_size, nb_action):
        ...
        self.fc4 = NoisyLinear(28, nb_action)
...
class Dqn():
    ...
    def learn(self, batch_state, batch_next_state, batch_reward, batch_action, weights, indices):
        ...
        loss = (td_erros.pow(2) * weights).mean() #PER pondéré
        ...
        self.soft_update()
        new_priorities = td_erros.abs().cpu().numpy() + self.epsilon
