...
class ModelService:
    ...
    def _load(self) -> None:
        ...
        self.mdl = AutoModelForCausalLM.from_pretrained(
            ...
            use_safetensors=True,              # compatible DeepSeek
        )
    ...
    def generate(self, messages: List[Dict[str, str]], **gen_kwargs) -> str:
        ...
        defaults = dict(
            ...
            temperature=0.8,
            top_p=0.9,
            repetition_penalty=1.05,         # un peu plus doux que Mistral
...
#
# Dépannage:
# - FileNotFoundError adapter → vérifier MODEL_ADAPTER_PATH ou le dossier 'deepseek-qwen7b-unikin-lora-final2'.
