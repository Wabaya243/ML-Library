# ==========================================================
# Fine-tuning LoRA (4-bit) sur Falcon3-Mamba-7B-Instruct
...
class PerfAndMem(TrainerCallback):
    ...
    def on_log(self, args, state, control, logs=None, **kwargs):
        ...
        self.t0 = time.time(); self.last_step = steps
...
class SpyderFriendlyCallback(TrainerCallback):
    def on_log(self, args, state, control, logs=None, **kwargs):
        if logs: print(logs); sys.stdout.flush()
...
# ==================== Trainer TRL (SFT) ====================
cfg_kwargs = dict(
    output_dir="./falcon3mamba7b-unikin",
...
adapter_out = "./falcon3mamba7b-unikin-lora-final"
