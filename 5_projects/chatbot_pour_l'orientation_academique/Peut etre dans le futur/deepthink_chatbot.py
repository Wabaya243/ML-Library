# ==========================================================
# LoRA 4-bit — Deepthink-Reasoning-7B (UNIKIN)
...
import trl
from collator import DataCollatorAssistantOnlyDeepthink
...
# ========================= LoRA =========================
lora = LoraConfig(
    r=8, lora_alpha=16, lora_dropout=0.15, bias="none",
...
# ========================= Trainer TRL =========================
cfg_kwargs = dict(
    output_dir="./deepthink-7b-unikin",
...
collator = DataCollatorAssistantOnlyDeepthink(tokenizer)
...
# ========================= Sauvegarde =========================
adapter_out = "./deepthink-7b-unikin-lora"
