...
- `generate_reply` doit être remplacée par ton vrai modèle (Mistral finetuné par ex).
"""
...
def generate_reply(context: List[Dict[str, str]]) -> str:
    """Appelle le modèle local pour générer une réponse ou renvoie un fallback si erreur."""
    try:
